#ifndef VIEWERQGL_INTERFACE_H
#define VIEWERQGL_INTERFACE_H
...
#include "ViewerQGL_config.h" // for VIEWER_EXPORT

class VIEWERQGL_EXPORT ViewerQGL_interface : public QGLViewer, public QOpenGLFunctions_2_1 {

	Q_OBJECT

public:
	ViewerQGL_interface(QWidget* parent) : QGLViewer(CGAL::Qt::createOpenGLContext(), parent) {}
	virtual ~ViewerQGL_interface() {}
